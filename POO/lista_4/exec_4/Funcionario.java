...
public class Funcionario
{
	...
	public Funcionario clone()
	{
		...
		clone = new Funcionario(this.nome, this.salario_hora);

		return clone;
	}

	public Boolean equals(Funcionario func_teste)
	{

		if(this.nome == func_teste.nome && this.salario_hora == func_teste.salario_hora)
			return true;
		else
			return false;
	}
