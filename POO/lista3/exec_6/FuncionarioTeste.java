...
public static void main(String args[])
{
    ...
    if(func.getProxId()==3)
        System.out.println("\nproxId atribuida corretamente! valor esperado = 3, retornado = " + func.getProxId());
    else
    {
        System.out.println("\nproxId atribuida errada. esperado valor = 3, retorno = " + func.getProxId());
        return;
    }
