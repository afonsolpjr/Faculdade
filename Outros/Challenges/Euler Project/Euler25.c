...
int fibbo(int limit)
{
    ...
    while(n_1->n_digit!=1000)
    {
        ...
        if(n->n_digit>950)
        {
            printf("F(%d) tem %d digitos\n",i,n->n_digit);
        }
        i++;
    }

    
    // n é o numero da sequencia, mas aqui queremos seus digitos. para uso futuro mude o tipo de retorno da funcao
    return n->n_digit;
}
